...
fn test_check() {
    ...
    assert_approx_eq!(check(1), dice::roll_over(2));
}
...
fn test_attack_precision() {
    ...
    assert_approx_eq!(attack_precision(1, 1), (5.0/6.0) * (5.0/6.0));
}
...
fn test_attack_unsaved() {
    ...
    assert_approx_eq!(attack_unsaved(1, 1, 2, 1), (5.0/6.0) * (5.0/6.0) * (1.0/6.0));
}
